...
def calculate_capacitive_load(capacitance_pf: float, voltage_v: float, frequency_hz: float) -> tuple[float, float, float]:
    """
...
def calculate_total_load_capacitance(c_dut_pf: float, c_stray_pf: float, impulse_type: str, c_divider_f: float, c_chopping_gap_f: float = 0.0) -> float:
    """
