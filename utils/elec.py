    ...
    try:
        ...
        if tipo == "Trifásico":
            ...
            if tensao_at_maior > 0:
                ...
                log.debug(
                    f"[elec] Corrente AT tap maior calculada: {result['corrente_nominal_at_tap_maior']}A"
                )
            ...
            if tensao_at_menor > 0:
                ...
                log.debug(
                    f"[elec] Corrente AT tap menor calculada: {result['corrente_nominal_at_tap_menor']}A"
                )
            ...
            if tensao_terciario > 0:
                ...
                log.debug(
                    f"[elec] Corrente Terciário calculada: {result['corrente_nominal_terciario']}A"
                )
        else:  # Monofásico
            if tensao_at > 0:
                result["corrente_nominal_at"] = round((potencia * 1000) / tensao_at, 2)
                log.debug(
                    f"[elec] Corrente AT calculada (monofásico): {result['corrente_nominal_at']}A"
                )
            ...
            if tensao_at_maior > 0:
                ...
                log.debug(
                    f"[elec] Corrente AT tap maior calculada (monofásico): {result['corrente_nominal_at_tap_maior']}A"
                )
            ...
            if tensao_at_menor > 0:
                ...
                log.debug(
                    f"[elec] Corrente AT tap menor calculada (monofásico): {result['corrente_nominal_at_tap_menor']}A"
                )

            if tensao_bt > 0:
                result["corrente_nominal_bt"] = round((potencia * 1000) / tensao_bt, 2)
                log.debug(
                    f"[elec] Corrente BT calculada (monofásico): {result['corrente_nominal_bt']}A"
                )
            ...
            if tensao_terciario > 0:
                ...
                log.debug(
                    f"[elec] Corrente Terciário calculada (monofásico): {result['corrente_nominal_terciario']}A"
                )
