...
ROUTE_DIELECTRIC_ANALYSIS = 'analise-dieletrica'  # Alias para manter compatibilidade com ambos os nomes
ROUTE_DIELECTRIC_COMPREHENSIVE = 'analise-dieletrica-completa'  # Nova rota para análise dielétrica completa
