...
RESISTORS_LI_FRONT_AVAILABLE = [
    {"value": 15, "label": "15 Ω"}, {"value": 20, "label": "20 Ω"}, {"value": 40, "label": "40 Ω"},
    {"value": 60, "label": "60 Ω"}, {"value": 90, "label": "90 Ω"},
    {"value": 140, "label": "140 Ω"}, {"value": 300, "label": "300 Ω"}
]
RESISTORS_LI_TAIL_AVAILABLE = [
    {"value": 100, "label": "100 Ω"}, {"value": 220, "label": "220 Ω"},
    {"value": 300, "label": "300 Ω"}, {"value": 600, "label": "600 Ω"},
    {"value": 3500, "label": "3.5 kΩ"},{"value": 5000, "label": "5.0 kΩ"}
]
RESISTORS_SI_FRONT_AVAILABLE = [
    {"value": 440, "label": "440 Ω"}, {"value": 900, "label": "900 Ω"},
    {"value": 1000, "label": "1.0 kΩ"}, {"value": 3000, "label": "3.0 kΩ"},
    {"value": 6000, "label": "6.0 kΩ"},
]
RESISTORS_SI_TAIL_AVAILABLE = [
    {"value": 1600, "label": "1.6 kΩ"}, {"value": 2200, "label": "2.2 kΩ"},
    {"value": 3600, "label": "3.6 kΩ"}, {"value": 4500, "label": "4.5 kΩ"},
    {"value": 5000, "label": "5.0 kΩ"},
]
INDUCTORS_OPTIONS = [
    {"value": 0, "label": "Nenhum"}, {"value": 100e-6, "label": "100 µH"},
    {"value": 200e-6, "label": "200 µH"}, {"value": 300e-6, "label": "300 µH"},
    {"value": 400e-6, "label": "400 µH"}
]
SHUNT_OPTIONS = [
    {"value": 0.01, "label": "0.01 Ω"}, {"value": 0.02, "label": "0.02 Ω"},
    {"value": 0.1, "label": "0.1 Ω"}, {"value": 0.5, "label": "0.5 Ω"},
...
RESONANT_SYSTEM_CONFIGS = {
    ...
    "Módulos 1+2+3 (Série)": { "tensao_max": 1350, "cap_min": 0.22, "cap_max": 2.6, "corrente": 1.33, "potencia": 1800 },
    "Módulos 1+2 (Série)": { "tensao_max": 900, "cap_min": 0.3, "cap_max": 6.5, "corrente": 1.33, "potencia": 1200 },
    "Módulo 1 (1 em Par.)": { "tensao_max": 450, "cap_min": 0.7, "cap_max": 13.1, "corrente": 1.33, "potencia": 600 },
    "Módulos 1||2||3 (3 Par.) 450kV": { "tensao_max": 450, "cap_min": 2.0, "cap_max": 23.6, "corrente": 4.0, "potencia": 1800 },
    "Módulos 1||2||3 (3 Par.) 27": { "tensao_max": 270, "cap_min": 23.7, "cap_max": 39.3, "corrente": 4.0, "potencia": 1800 }
}
...
LOSSES_TOLERANCE_INDIVIDUAL = 0.15 # +15% para perdas em vazio OU carga (se garantidas separadamente)
...
Q_SWITCH_POWERS = {
    "generic_cp": [0.1, 0.2, 0.8, 1.2, 1.6]
}
...
SUT_AT_MIN_VOLTAGE = 14000.0
SUT_AT_MAX_VOLTAGE = 140000.0
SUT_AT_STEP_VOLTAGE = 3000.0
EPS_CURRENT_LIMIT = 1950.0
DUT_POWER_LIMIT = 1350.0
