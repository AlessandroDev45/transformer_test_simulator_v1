...
class TransformerInputsData(BaseModel):
    tipo_transformador: Optional[str] = Field(default='Trifásico', description="Tipo: Monofásico ou Trifásico")
    ...
    corrente_nominal_at: Optional[float] = Field(default=None, description="Corrente nominal AT (A) - Calculada")
    impedancia: Optional[float] = Field(default=None, description="Impedância nominal (%)")
    nbi_at: Optional[Union[int, float, str]] = Field(default=None, description="NBI AT (kV)") # Accept string for 'na'
    sil_at: Optional[Union[int, float, str]] = Field(default=None, description="SIL AT (kV)") # Accept string for 'na'
    conexao_at: Optional[str] = Field(default='estrela', description="Conexão AT (estrela, estrela_sem_neutro, triangulo)")
    classe_tensao_at: Optional[float] = Field(default=None, description="Classe Tensão AT (kV)")
    elevacao_enrol_at: Optional[float] = Field(default=None, description="Elev. Enrolamento AT (°C)")
    tensao_bucha_neutro_at: Optional[float] = Field(default=None, description="Tensão Bucha Neutro AT (kV)")
    nbi_neutro_at: Optional[Union[int, float, str]] = Field(default=None, description="NBI Neutro AT (kV)") # Accept string for 'na'
    # AT Taps
    tensao_at_tap_maior: Optional[float] = Field(default=None, description="Tensão Tap+ AT (kV)")
    corrente_nominal_at_tap_maior: Optional[float] = Field(default=None, description="Corrente Tap+ AT (A) - Calculada")
    ...
    corrente_nominal_at_tap_menor: Optional[float] = Field(default=None, description="Corrente Tap- AT (A) - Calculada")
    ...
    corrente_nominal_bt: Optional[float] = Field(default=None, description="Corrente nominal BT (A) - Calculada")
    ...
    conexao_bt: Optional[str] = Field(default='triangulo', description="Conexão BT (estrela, estrela_sem_neutro, triangulo)")
    classe_tensao_bt: Optional[float] = Field(default=None, description="Classe Tensão BT (kV)")
    elevacao_enrol_bt: Optional[float] = Field(default=None, description="Elev. Enrolamento BT (°C)")
    tensao_bucha_neutro_bt: Optional[float] = Field(default=None, description="Tensão Bucha Neutro BT (kV)")
    nbi_neutro_bt: Optional[Union[int, float, str]] = Field(default=None, description="NBI Neutro BT (kV)")
    # Terciario
    tensao_terciario: Optional[float] = Field(default=None, description="Tensão nominal Terciário (kV)")
    corrente_nominal_terciario: Optional[float] = Field(default=None, description="Corrente nominal Terciário (A) - Calculada")
    nbi_terciario: Optional[Union[int, float, str]] = Field(default=None, description="NBI Terciário (kV)")
    sil_terciario: Optional[Union[int, float, str]] = Field(default=None, description="SIL Terciário (kV)")
    conexao_terciario: Optional[str] = Field(default='', description="Conexão Terciário (estrela, estrela_sem_neutro, triangulo, '')")
    classe_tensao_terciario: Optional[float] = Field(default=None, description="Classe Tensão Terciário (kV)")
    elevacao_enrol_terciario: Optional[float] = Field(default=None, description="Elev. Enrolamento Terciário (°C)")
    tensao_bucha_neutro_terciario: Optional[float] = Field(default=None, description="Tensão Bucha Neutro Terciário (kV)")
    nbi_neutro_terciario: Optional[Union[int, float, str]] = Field(default=None, description="NBI Neutro Terciário (kV)")
    # Geral
    ...
    teste_tensao_aplicada_bt: Optional[Union[int, float, str]] = Field(default=None, description="Tensão Aplicada BT (kV)")
    teste_tensao_aplicada_terciario: Optional[Union[int, float, str]] = Field(default=None, description="Tensão Aplicada Terciário (kV)")
    teste_tensao_induzida: Optional[Union[int, float, str]] = Field(default=None, description="Tensão Induzida AT (kV)")
    # Pesos
    ...
    peso_tanque_acessorios: Optional[float] = Field(default=None, description="Peso Tanque/Acessórios (ton)")
    timestamp: Optional[datetime.datetime] = Field(default=None, description="Timestamp da última atualização")
...
class DielectricAnalysisData(BaseModel):
    parametros: Optional[Dict[str, Any]] = Field(default={}) # Inclui enrolamentos, tipo_transformador, tipo_isolamento
    resultados: Optional[Dict[str, Any]] = Field(default={}) # Inclui enrolamentos, ensaios_requeridos, sequencias_ensaio
    timestamp: Optional[datetime.datetime] = Field(default=None)
    tensao_induzida: Optional[Dict[str, Optional[Union[str, float]]]] = Field(default={}) # Adicionado
