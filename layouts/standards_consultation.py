    ...
    layout = dbc.Container([
        ...
        dbc.Row([
                ...
                dbc.Card([
                    ...
                    dbc.CardBody([
                        dcc.Loading(
                            ...
                            type="circle",
                            children=html.Div(id="standards-categories-container")
                        )
                    ])
                ], className="mb-3"),
            ...
            dbc.Col([
                ...
                html.Div([
                    dbc.Card([
                        dbc.CardHeader("Resultados da Busca", className="fw-bold"),
                        dbc.CardBody([
                            html.Div(id="standards-search-results")
                        ])
                    ])
                ], id="standards-search-results-container", style={"display": "none"}, className="mb-3"),

                # Visualizador de norma
                dbc.Card([
                    dbc.CardHeader([
                        html.Span("Visualizador de Norma", id="standards-viewer-title", className="fw-bold"),
                        dbc.Button(
                    ...
                    dbc.CardBody([
                        dcc.Loading(
                            ...
                            children=html.Div([
                                # Metadados da norma
                                html.Div(id="standards-metadata-display", className="mb-3"),
