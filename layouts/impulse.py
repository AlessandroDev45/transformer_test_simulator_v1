...
try:
    ...
    from utils.constants import GENERATOR_CONFIGURATIONS, INDUCTORS_OPTIONS, SHUNT_OPTIONS
...
def create_impulse_layout():
    ...
    try:
        ...
        if hasattr(app, "mcp") and app.mcp is not None:
            ...
            log.info(
                f"[Impulse] Dados do transformador obtidos do MCP: {len(transformer_data) if isinstance(transformer_data, dict) else 'Não é dict'}"
            )
        # Se não conseguir do MCP, tenta do cache
            ...
            log.info(
                f"[Impulse] Dados do transformador obtidos do cache: {len(transformer_data) if isinstance(transformer_data, dict) else 'Não é dict'}"
            )
        else:
    ...
    return dbc.Container(
        [
            ...
            dcc.Location(
                id="url-impulse-section", refresh=False
            ),  # Mantido para trigger de pathname
            ...
            dbc.Row(
                ...
                className="mb-1",
            ),  # Reduzida a margem inferior da linha de info
                        ...
                        [
                            ...
                            dbc.Row(
                                [
                                    ...
                                    dbc.Col(
                                        html.H6(
                                            "Simulação de Ensaios de Impulso CDYH-2400kV/360kJ Impulse Voltage Test System",
                                ...
                                className="mb-1 border-bottom align-items-center",
                            ),  # Reduzido mb, alinhado itens verticalmente
                            ...
                            dbc.Row(
                                [
                                    ...
                                    dbc.Col(
                                        [
                                            ...
                                            dbc.Card(
                                                                        ...
                                                                        [
                                                                            ...
                                                                            dcc.Dropdown(
                                                                                ...
                                                                                options=[
                                                                                    ...
                                                                                    for cfg in GENERATOR_CONFIGURATIONS
                                                                                ],  # Usando cfg em vez de config
                                                                                value="6S-1P",
                                                                                clearable=False,
                                                                                style={
                                                                                    "fontSize": "0.75rem",
                                                ...
                                                className="mb-1",
                                            ),  # Reduzido margin bottom ainda mais
                                    ...
                                    dbc.Col(
                                            ...
                                            dbc.Row(
                                                [
                                                    dbc.Col(
                                                        [
                                                            html.H6(
                                                                id="waveform-title-display",
                                                                children="Forma de Onda de Tensão e Corrente",
                                                            ...
                                                            dbc.Button(
                                                                [
                                                                    html.Span(
                                                                        ...
                                                                        id="simulate-button-text",
                                                                    ),
                                                                    dbc.Spinner(
                                                                        size="sm",
                                                                        color="light",
                                                                        id="simulate-spinner",
                                                                        spinner_class_name="ms-2 d-none",
                                                                    ),
                                                                ],
                                                                id="simulate-button",
                                                                color="primary",
                                                        ...
                                                        [
                                                            html.Div(
                                                                [
                                                                    ...
                                                                    dbc.Alert(
                                                                        "Não Conforme",
                                                                        id="compliance-overall-alert",
                                                                        color="danger",
                                                                        className="py-1 px-2 m-0 me-1 d-none",
                                                                        style={
                                                                            "fontSize": "0.75rem"
                                                                        },
                                                                    ),  # d-none por padrão
                                                                    ...
                                                                    dbc.Alert(
                                                                        html.Span(
                                                                            [
                                                                                html.I(
                                                                                    className="fas fa-wave-square me-1"
                                                                                ),
                                                                                "Oscilatório",
                                                                            ]
                                                                        ),
                                                                        id="oscillation-warning-alert",
                                                                        color="warning",
                                                                        className="py-1 px-2 m-0 me-1 d-none",
                                                                        style={
                                                                            "fontSize": "0.75rem"
                                                                    ...
                                                                    dbc.Alert(
                                                                        ...
                                                                        id="shunt-voltage-alert",
                                                                        color="danger",
                                                                        className="py-1 px-2 m-0 d-none",
                                                                        style={
                                                                            "fontSize": "0.75rem"
                                                                        },
                                                                    ),  # d-none por padrão
                                                            ...
                                                            )  # flex-wrap para quebrar linha se necessário
                                                        ],
                                                        width=12,
                                                    )
                                                ],
                                                className="mb-1",
                                            ),  # Mantido mb-1 para espaço mínimo
                                        ...
                                        width=5,
                                        className="px-1",
                                    ),  # Fim da coluna de gráficos - reduzida para 5
                                    ...
                                    dbc.Col(
                                        [
                                            ...
                                            dbc.Card(
                                                [
                                                    dbc.CardHeader(
                                                        "Indutâncias e Componentes Adicionais",
                                                        className="p-1 text-center fw-bold fs-6",
                                                        style=card_header_style,
                                                    ),
                                                    dbc.CardBody(
                                                        [
                                                            ...
                                                            dbc.Row(
                                                                                ...
                                                                                [
                                                                                    ...
                                                                                    dcc.Dropdown(
                                                                                        ...
                                                                                        options=[
                                                                                            ...
                                                                                            for option in INDUCTORS_OPTIONS
                                                                                        ],
                                                                                        value=0,
                                                                                        clearable=False,
                                                                                        style={
                                                                ...
                                                                className="g-2 mb-1",
                                                            ),  # Fim da Linha 1 - Reduzido espaçamento
                                                            ...
                                                            dbc.Row(
                                                                ...
                                                                className="g-2 mb-1",
                                                            ),  # Fim da Linha 2 - Reduzido espaçamento
                                                                    ...
                                                                    dbc.Col(
                                                                        [
                                                                            dbc.Collapse(
                                                                                        ...
                                                                                        [
                                                                                            ...
                                                                                            dbc.Row(
                                                                                                [
                                                                                                    dbc.Col(
                                                                                                        html.Div(
                                                                                                            id="calculated-inductance-display",
                                                                                ...
                                                                                id="transformer-calc-collapse",
                                                                                is_open=False,
                                                                            )
                                                                        ],
                                                                        width=12,
                                                                    )  # Collapse ocupa a linha inteira
                                                                ],
                                                                className="mb-1",
                                                            ),  # Linha apenas para o Collapse
                                                            # Alerta SI (mantido)
                                                            dbc.Alert(
                                                                "Atenção: Modelo SI é experimental e pode não refletir todos os efeitos.",
                                                                id="si-model-warning-alert",
                                                                color="warning",
                                                                className="py-1 px-2 m-0 mt-2",
                                                                style={
                                                                    "fontSize": "0.7rem",
                                                                    "display": "none",
                                                                },
                                                ...
                                                [
                                                    ...
                                                    dbc.Tab(
                                                        html.Div(  # Container para a tabela
                                                            ...
                                                            children=[
                                                                dbc.Alert(
                                                                    "Simule para ver detalhes de energia.",
                                                                    color="info",
                                                                    className="m-2",
                                                                    style={
                                                                        "fontSize": "0.7rem",
                                        ...
                                        width=4,
                                        className="ps-1",
                                    ),  # Fim da coluna de resultados - aumentada para 4
                                ]
                            ),
                            # Stores are now defined in components/global_stores.py and included in main_layout.py
                            ...
                            dcc.Interval(
                                id="auto-simulate-interval",
                                interval=1 * 1000,
                                n_intervals=0,
                                disabled=True,
                            ),  # Intervalo ajustado para 1s
                        ]
