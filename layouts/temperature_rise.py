    ...
    return dbc.Container([
        ...
        dbc.Row([
            dbc.Col([
                ...
                html.Div([
                    # Painel de informações do transformador
        ...
        dbc.Card([
            dbc.CardHeader(
                html.Div([
                    html.H6("ANÁLISE DE ELEVAÇÃO DE TEMPERATURA", className="text-center m-0 d-inline-block", style=TYPOGRAPHY['card_header']),
                    # Botão de ajuda
                    create_help_button("temperature_rise", "Ajuda sobre Elevação de Temperatura")
        ...
        dbc.Row([
            ...
            dbc.Col([
                    ...
                    dbc.CardBody([
                        ...
                        dbc.Row([
                            ...
                            dbc.Col([
                                dbc.Row([
                                    dbc.Col([
                                        dbc.Label("Material Enrolamento:", style=TYPOGRAPHY['label'], html_for='winding-material'),
                                    ], width=7),
                                    dbc.Col([
                                        dcc.Dropdown(
                                            id='winding-material',
                        ...
                        html.Div("Medições a Frio",
                                style={"fontSize": "0.8rem", "fontWeight": "bold", "marginBottom": "0.5rem", "color": COLORS['text_light']}),
                        dbc.Row([
                            # Resistência Fria
                            dbc.Col([
                                create_labeled_input(
                                    "Res. Fria (Rc) (Ohm):", "res-cold", placeholder="Ohm @ Θc",
                                    label_width=7, input_width=5, persistence=True, persistence_type='local', step='any'
                                )
                            ], width=6),
                            ...
                            dbc.Col([
                                create_labeled_input(
                                    "Temp. Ref. Fria (Θc) (°C):", "temp-cold", placeholder="Temp. Rc",
                                    label_width=7, input_width=5, persistence=True, persistence_type='local'
                                )
                            ], width=6),
                        ], className="mb-3"),
                        ...
                        html.Div("Medições a Quente",
                                style={"fontSize": "0.8rem", "fontWeight": "bold", "marginBottom": "0.5rem", "color": COLORS['text_light']}),
                        dbc.Row([
                            # Resistência Quente
                            dbc.Col([
                                create_labeled_input(
                                    "Res. Quente (Rw) (Ohm):", "res-hot", placeholder="Ohm @ t=0",
                                    label_width=7, input_width=5, persistence=True, persistence_type='local', step='any'
                                ),
                                dbc.Tooltip(
                            ...
                            dbc.Col([
                                create_labeled_input(
                                    "Temp. Topo Óleo (Θoil) (°C):", "temp-top-oil", placeholder="Final",
                                    label_width=7, input_width=5, persistence=True, persistence_type='local'
                                )
                            ], width=6),
                        ], className="mb-3"),
                        ...
                        html.Div("Parâmetro para Constante de Tempo Térmica",
                                style={"fontSize": "0.8rem", "fontWeight": "bold", "marginBottom": "0.5rem", "color": COLORS['text_light']}),
                        dbc.Row([
                            dbc.Col([
                                dbc.Row([
                                    dbc.Col([
                                        dbc.Label("Elevação Máx Óleo (ΔΘoil_max) (K):", style=TYPOGRAPHY['label'], html_for="delta-theta-oil-max"),
                                    ], width=7),
                                    dbc.Col([
                                        dbc.Input(
                                            type="number",
                        ...
                        # Mensagem de erro
                        html.Div(id='temp-rise-error-message', className="mt-2", style=TYPOGRAPHY['error_text'])
                ...
                dbc.Card([
                    dbc.CardHeader(
                        html.H6("Diagrama de Elevação de Temperatura", className="m-0", style=TYPOGRAPHY['card_header']),
                        style=COMPONENTS['card_header']
                    ),
                    dbc.CardBody([
            ...
            ], md=6, className=SPACING['col_padding']),
            ...
            dbc.Col([
                ...
                dbc.Card([
                    dbc.CardHeader(
                        html.H6("Resultados Calculados", className="m-0", style=TYPOGRAPHY['card_header']),
                        style=COMPONENTS['card_header']
                    ),
                    dbc.CardBody(
                        dcc.Loading([
                            # Seção 1: Temperaturas e Elevações
                            html.Div("Temperaturas e Elevações",
                                    style={"fontSize": "0.8rem", "fontWeight": "bold", "marginBottom": "0.5rem", "color": COLORS['text_light']}),
                            dbc.Row([
                                # Temperatura Média do Enrolamento
                                dbc.Col([
                                    dbc.Row([
                                        dbc.Col(html.Label("Temp. Média Enrol. Final (Θw):", style=TYPOGRAPHY['label']), width=7),
                                        dbc.Col(dbc.Input(id="avg-winding-temp", type="number", readonly=True, style=COMPONENTS['read_only'], persistence=True, persistence_type='local'), width=5)
                                ...
                                dbc.Col([
                                    dbc.Row([
                                        dbc.Col(html.Label("Elevação Média Enrol. (ΔΘw):", style=TYPOGRAPHY['label']), width=7),
                                        dbc.Col(dbc.Input(id="avg-winding-rise", type="number", readonly=True, style=COMPONENTS['read_only'], persistence=True, persistence_type='local'), width=5)
                                    ], className="mb-2 align-items-center"),
                                ], width=12),
                                ...
                                dbc.Col([
                                    dbc.Row([
                                        dbc.Col(html.Label("Elevação Topo Óleo (ΔΘoil):", style=TYPOGRAPHY['label']), width=7),
                                        dbc.Col(dbc.Input(id="top-oil-rise", type="number", readonly=True, style=COMPONENTS['read_only'], persistence=True, persistence_type='local'), width=5)
                                    ], className="mb-2 align-items-center"),
                                ], width=12),
                            ]),

                            # Seção 2: Parâmetros Térmicos
                            html.Div("Parâmetros Térmicos",
                                    style={"fontSize": "0.8rem", "fontWeight": "bold", "marginTop": "1rem", "marginBottom": "0.5rem", "color": COLORS['text_light']}),
                            dbc.Row([
                                # Perdas Totais Usadas
                                dbc.Col([
                                    dbc.Row([
                                        dbc.Col(html.Label("Perdas Totais Usadas (Ptot):", style=TYPOGRAPHY['label']), width=7),
                                        dbc.Col(dbc.Input(id="ptot-used", type="number", readonly=True, placeholder="kW", style=COMPONENTS['read_only'], persistence=True, persistence_type='local'), width=5)
                                    ], className="mb-2 align-items-center"),
                                ], width=12),
                                ...
                                dbc.Col([
                                    dbc.Row([
                                        dbc.Col(html.Label("Const. Tempo Térmica (τ₀):", style=TYPOGRAPHY['label']), width=7),
                                        dbc.Col(dbc.Input(id="tau0-result", type="number", readonly=True, placeholder="horas", style=COMPONENTS['read_only'], persistence=True, persistence_type='local'), width=5)
                                    ], className="mb-2 align-items-center"),
                                ], width=12),
                            ]),

                            # Seção 3: Fórmulas Utilizadas
                            html.Div("Fórmulas Utilizadas",
                                    style={"fontSize": "0.8rem", "fontWeight": "bold", "marginTop": "1rem", "marginBottom": "0.5rem", "color": COLORS['text_light']}),
                            dbc.Card([
                                dbc.CardBody([
                                    html.P([
                                        html.Span("Temperatura Média do Enrolamento:", style={"fontWeight": "bold"}),
                                        html.Br(),
                                        "Θw = Θa + [(Rw/Rc) × (C + Θc) - C]"
                                    ], style={"fontSize": "0.7rem", "marginBottom": "0.5rem"}),
                                    html.P([
                                        html.Span("Elevação Média do Enrolamento:", style={"fontWeight": "bold"}),
                                        html.Br(),
                                        "ΔΘw = Θw - Θa"
                                    ], style={"fontSize": "0.7rem", "marginBottom": "0.5rem"}),
                                    html.P([
                                        html.Span("Elevação do Topo do Óleo:", style={"fontWeight": "bold"}),
                                        html.Br(),
                                        "ΔΘoil = Θoil - Θa"
                                    ], style={"fontSize": "0.7rem", "marginBottom": "0.5rem"}),
                                    html.P([
                                        html.Span("Constante de Tempo Térmica:", style={"fontWeight": "bold"}),
                                        html.Br(),
                                        "τ₀ = 0.132 × (mT - 0.5 × mO) × ΔΘoil_max / Ptot"
                                    ], style={"fontSize": "0.7rem", "marginBottom": "0"})
                                ], style={"padding": "0.5rem"})
                            ], style={"backgroundColor": COLORS['background_card'], "border": f"1px solid {COLORS['border']}"}),

                            # Notas Explicativas
                            html.Hr(className="my-3"),
                            dbc.Alert([
                                html.P([
                                    html.Strong("Nota 1:"), " Cálculos conforme NBR 5356-2. Rw deve ser o valor extrapolado para t=0.",
                                    html.Br(),
                                    html.Strong("Nota 2:"), " O cálculo de τ₀ requer ΔΘoil_max, Pesos (Dados Básicos) e Perdas Totais (Perdas).",
                                    html.Br(),
                                    html.Strong("Nota 3:"), " C = 234,5 para cobre e 225 para alumínio."
