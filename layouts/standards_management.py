            ...
            dbc.Col([
                dbc.Card([
                    ...
                    dbc.CardBody([
                        # Upload de PDF
                        html.Div([
                            html.Label("Arquivo PDF da Norma", className="form-label"),
                            dcc.Upload(
                                id="upload-standard-pdf",
                                children=html.Div([
                                    'Arraste e solte ou ',
                                    html.A('selecione um arquivo PDF', className="text-primary")
                                ]),
                                style={
                                    'width': '100%',
                                    'height': '60px',
                            ...
                            html.Div(id="upload-standard-info", className="mt-2")
                        ], className="mb-3"),

                        # Metadados da norma
                        dbc.Row([
                            dbc.Col([
                                html.Label("Título da Norma", className="form-label"),
                                dbc.Input(
                            ...
                            dbc.Col([
                                html.Label("Número da Norma", className="form-label"),
                                dbc.Input(
                            ...
                            dbc.Col([
                                html.Label("Organização", className="form-label"),
                                dbc.Input(
                            ...
                            dbc.Col([
                                html.Label("Ano de Publicação", className="form-label"),
                                dbc.Input(
                            ...
                            dbc.Col([
                                html.Label("Categorias (separadas por vírgula)", className="form-label"),
                                dbc.Input(
                        ...
                        html.Div(
                            ...
                            className="mt-3",
                            children=html.Div("Pronto para processar normas", className="text-muted")
                        )
                    ])
                ], className="mb-4")
            ], width=6),
