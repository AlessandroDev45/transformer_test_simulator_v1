...
def create_short_circuit_layout():
    ...
    try:
        ...
        if hasattr(app, "mcp") and app.mcp is not None:
            ...
            log.info(
                f"[Short Circuit] Dados do transformador obtidos do MCP: {len(transformer_data) if isinstance(transformer_data, dict) else 'Não é dict'}"
            )
        # Se não conseguir do MCP, tenta do cache
            ...
            log.info(
                f"[Short Circuit] Dados do transformador obtidos do cache: {len(transformer_data) if isinstance(transformer_data, dict) else 'Não é dict'}"
            )
        else:
            log.warning(
                "[Short Circuit] Dados do transformador não encontrados no MCP nem no cache"
            )
                                                    ...
                                                    dbc.CardBody(
                                                        [
                                                            ...
                                                            dbc.Alert(
                                                                [
                                                                    html.P(
                                                                        "Cálculos e verificações baseados na NBR 5356-5 / IEC 60076-5.",
                                                                        className="mb-0",
                                                                        style={
                                                                            "fontSize": "0.7rem"
                                                                        },
                                                            ...
                                                            # Mensagem de erro
                                                            html.Div(
                                                                id="short-circuit-error-message",
                                                                className="mt-2",
                                                                                ...
                                                                                [
                                                                                    html.P(
                                                                                        [
                                                                                            ...
                                                                                            " Cálculos de Isc e ip são simplificados.",
                                                                                            html.Br(),
                                                                                            html.Strong(
                                                                                                "Nota 2:"
                                                                                            ),
                                                                                            " Limites de ΔZ% conforme NBR 5356-5 Tabela 2.",
                                                                                        ],
                                                                                        style=TYPOGRAPHY[
                                                                                            "small_text"
                                                                                        ],
                                                    ...
                                                    dbc.CardBody(
                                                        [
                                                            ...
                                                            dcc.Loading(
                                                                html.Div(
                                                                    dcc.Graph(
                                                                        id="impedance-variation-graph",
                                                                        figure=create_empty_sc_figure(),
                                                                        config={
                                                                            "displayModeBar": True,
                                                                            "displaylogo": False,
