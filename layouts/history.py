                        ...
                        html.Div(
                            [
                                html.I(
                                    ...
                                    style={"fontSize": "1.8rem", "color": COLORS["accent"]},
                                ),
                                html.H4(
                        ...
                        dbc.Card(
                            [
                                dbc.CardHeader(
                                    ...
                                    style={**COMPONENTS["card_header"], "textAlign": "left"},
                                ),
                                dbc.CardBody(
                                    [
                                        dbc.Row(
                                            [
                                                ...
                                                dbc.Col(
                                                    dbc.Button(
                                                        ...
                                                        id="save-current-session-button",
                                                        color="success",
                                                        className="w-100",
                                                        style=COMPONENTS["button_success"],
                                                    ),
                                                    md=5,
                                                    lg=4,
                                                ),
                                            ...
                                            html.Div(
                                                [
                                                    html.H5(
                                                        ...
                                                        children="--",
                                                        style=stats_value_style,
                                                    ),
                                                    html.P(
                                                        "Sessões Salvas", style=stats_label_style
                                                    ),
                                                ]
                                            ),
                                        ]
                                    ...
                                    html.Div(
                                        [
                                            html.I(
                                                ...
                                                style={**stats_icon_style, "color": COLORS["info"]},
                                            ),
                                            html.Div(
                                                [
                                                    html.H5(
                                                        id="stats-last-session",
                                                        children="--",
                                                        style=stats_value_style,
                                                    ),
                                                    html.P(
                                                        "Última Sessão Salva",
                                                        style=stats_label_style,
                                                    ),
                                                ]
                                            ),
                                        ]
                                    ...
                                    html.Div(
                                        [
                                            ...
                                            html.Div(
                                                [
                                                    html.H5(
                                                        id="stats-current-session",
                                                        children="Nova Sessão",
                                                        style=stats_value_style,
                                                    ),
                                                    html.P(
                                                        "Sessão em Edição", style=stats_label_style
                                                    ),
                                                ]
                                            ),
                                        ]
                                                            ...
                                                            [
                                                                ...
                                                                html.Div(
                                                                    html.Span(
                                                                        [
                                                                            html.I(
                                                                                className="fas fa-sticky-note me-1"
                                                                            ),
                                                                            "Notas",
                                                                        ]
                                                                    ),
                                                ...
                                                dbc.Col(
                                                    html.Div(
                                                        [
                                                            ...
                                                            html.Strong("Salvar:"),
                                                            " Guarda os dados da sessão atual com um nome único.",
                                                        ]
                                                    ),
                                                    md=6,
                                                    className="mb-2",
                                                ...
                                                dbc.Col(
                                                    html.Div(
                                                        [
                                                            ...
                                                            html.Strong("Carregar:"),
                                                            " Restaura os dados de uma sessão salva.",
                                                        ]
                                                    ),
                                                    md=6,
                                                    className="mb-2",
                                                ...
                                                dbc.Col(
                                                    html.Div(
                                                        [
                                                            ...
                                                            html.Strong("Excluir:"),
                                                            " Remove permanentemente a sessão selecionada.",
                                                        ]
                                                    ),
                                                    md=6,
                                                    className="mb-2",
                                                ...
                                                dbc.Col(
                                                    html.Div(
                                                        [
                                                            ...
                                                            html.Strong("Buscar:"),
                                                            " Filtra a lista por nome ou notas.",
                                                        ]
                                                    ),
                                                    md=6,
                                                    className="mb-2",
                ...
                [
                    ...
                    dbc.ModalBody(
                        [
                            dbc.Label(
                                "Nome da Sessão:",
                                html_for="session-name-input",
                                style=TYPOGRAPHY["label"],
                            ),
                            dbc.Input(
                                id="session-name-input",
                                placeholder="Identificador único para a sessão",
                                type="text",
                                className="mb-3",
                                style=COMPONENTS["input"],
                            ),
                            dbc.Label(
                                "Notas (Opcional):",
                                html_for="session-notes-input",
                                style=TYPOGRAPHY["label"],
                            ),
                            dbc.Textarea(
                                id="session-notes-input",
                                placeholder="Detalhes sobre o teste, equipamento, etc.",
                                style={**COMPONENTS["input"], "height": "100px"},
                            ),
                            html.Div(
                                [
                                    html.I(
                                    ...
                                    " Escolha um nome único. Nomes duplicados não são permitidos.",
                                ],
                    ...
                    dbc.ModalFooter(
                        [
                            dbc.Button(
                                "Cancelar",
                                id="save-session-cancel",
                                color="secondary",
                                outline=True,
                                style=COMPONENTS["button_secondary"],
                            ),
                            dbc.Button(
                                html.Span([html.I(className="fas fa-save me-1"), "Salvar"]),
                ...
                [
                    ...
                    dbc.ModalFooter(
                        [
                            ...
                            dbc.Button(
                                html.Span([html.I(className="fas fa-trash-alt me-1"), "Excluir"]),
