...
try:
    ...
    COLORS = {}
    TYPOGRAPHY = {}
    COMPONENTS = {'card':{}, 'card_header':{}, 'card_body':{}, 'input':{}, 'dropdown':{}, 'read_only':{}}
    SPACING = {'row_margin': '', 'row_gutter': '', 'col_padding': ''}
    TABLE_STYLES = {'header_sm':{}, 'header_md':{}, 'param_sm':{}, 'param_md':{}, 'value_sm':{}, 'value_md':{}, 'status':{}, 'wrapper':{}}
...
try:
    from utils.styles import PI, EPSILON_0, MU_0
except ImportError:
    PI = math.pi
